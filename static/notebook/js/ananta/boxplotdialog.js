...
var IPython = (function (IPython) {
    ...
    var BoxPlotDialog = function (selector) {
    };


    BoxPlotDialog.prototype.show_dialog = function (nb,selection,column_name) {
        ...
        var element =  $('<div id="boxvisdiv"></div>');
        ...
        boxPlotSelectGrapgh(selection);

        this.shortcut_dialog = IPython.dialog.modal({
            title : "Box Plot for Column "+column_name,
            body : element,
            destroy : false,
            buttons : {
                Close : {}
